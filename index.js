...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.eifhszm.mongodb.net/?retryWrites=true&w=majority`;
...
const run = async () => {
  try {
    ...
    app.patch("/apply", async (req, res) => {
      ...
      const updateDoc = {
        $push: { applicants: { id: ObjectId(userId), email, jobId } },
      };
